...
<table class="table">
	...
	<?php foreach($memberList as $key=>$member){?>
		<tr>
			...
			<td><a target="_bank" href="<?php echo Url::toRoute(['payment/paydetail','memberId'=>$member['memberId'],'date'=>date('d/m/Y',strtotime($date))]);?>"><?php echo $member['memberName']?></a></td>
			<td><a target="_bank" href="<?php echo Url::toRoute(['payment/paydetail','memberId'=>$member['memberId'],'date'=>date('d/m/Y',strtotime($date))]);?>"><?php echo $member['arrGroup']?></a></td>
